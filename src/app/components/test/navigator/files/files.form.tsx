    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1 h-screen">
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <ScrollView className="max-w-sm mx-auto w-full">
          ...
          <View className="mb-5">
            <Text className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</Text>
            <TextInput
              value={form?.name}
          ...
          <View className="mb-5">
            <Text className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</Text>
            <TextInput
              editable
              multiline
              numberOfLines={4}
          ...
          <View className="mb-5">
            <Text className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Logo URL</Text>
            <TextInput
              value={form?.logo}
